...
- Paper:
    ...
    - Can we talk about how best to present the LIME algorithm and some of the terms from the original paper that do not make sense in the context of the R package?
    - Subsections in the introduction?
    - See other comments in the paper
    - I am thinking about moving the paper to a new repository and then renaming this repository as LIME-research-journals and using it more as a place to try stuff out
- Graphics Group:
    - schedule
