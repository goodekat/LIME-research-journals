...
- Paper
    ...
    - I could not find a locality metric output from Python. There was a section in their vignettes that seemed to be referring to some sort of assessment about the models, but I'm not sure what was happening. https://marcotcr.github.io/lime/tutorials/Tutorial%20-%20continuous%20and%20categorical%20features.html
- Graphics Group
