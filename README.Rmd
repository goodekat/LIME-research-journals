...
- check to see if there a paper showing how ridge regression is affected by sample size changes
- try fitting the ridge regression with the observed data only to see how it compares to the model fit with the ridge regression
