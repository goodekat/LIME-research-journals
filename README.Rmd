...
0. [Objectives and Ideas]()
1. [Information on Hamby Data and Models]()
2. [Understanding LIME]()
3. [Applying LIME to Hamby Data]()
4. [Assessing LIME on Hamby Data]()
5. [Applying and Assessing LIME on Iris Data]()
6. [Notes on Readings]()
7. [Computational Issues]()
8. [LIME Applied to Logistic Regression]()
9. [Identifying `rtrees` Training Data]()
10. [LIME Variability Across Hamby Data and Models]()
