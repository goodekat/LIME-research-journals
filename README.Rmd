...
- Completed: 
    ...
    - added sine example and analysis of default LIME explanations to paper
    - started section on heatmap plot
- What do you think of my work on the methods section so far?
- Should we schedule my oral prelim, or should we keep waiting until I get closer to finishing the paper?
- What names should I give to the diagnostic plots?
- Color themes for the paper?
- Could you help me with the interpretation of the default LIME explanations?
- Metrics:
...
- did you have any resources for gganimate? (check out my slides so far)
