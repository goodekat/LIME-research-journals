...
## Talking points
  ...
  - poster:
      - how to cut down on the words?
      - formula for MSE?
      - do you have any ideas for better displaying the plots and
        descriptions in the middle column?
      - what do you think of the conceptual depiction of LIME?
      - recommendations for keeping figure text the same size?
