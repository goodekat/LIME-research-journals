...
Machine learning algorithms are known to provide accurate predictions. (include more about the usefulness of ml algorithms). However, this predictive ability comes at a cost. These algorithms are typically very complex and have no functional form. As a result, the ability to directly interpret the model is lost.
