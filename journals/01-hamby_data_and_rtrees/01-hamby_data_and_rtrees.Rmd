...
This journal includes a description of the Hamby datasets and the random forest model `rtrees` that will be used in this research project. Additionally, the specification and cleaning of the training and testing datasets are documented, and some initial visualizations of the random forest model are included.
