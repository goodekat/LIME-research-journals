...
This journal the applications of lime to the bullet data.
...
The code below applies the LIME algorithm to the bullet data for multiple different input cases. 
...
This code creates a dataframe of the bins to use in the app.
