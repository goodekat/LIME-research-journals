...
if(!file.exists("../data/hamby224_lime.rds")) {
  ...
  hamby224_lime_cases <- data.frame(bin_continuous = c(rep(TRUE, 18), rep(FALSE, 2)),
                                    quantile_bins = c(rep(TRUE, 9), rep(FALSE, 9), rep(NA, 2)),
                                    nbins = c(rep(2:10, 2), rep(NA, 2)),
                                    use_density = c(rep(NA, 18), TRUE, FALSE)) %>%
