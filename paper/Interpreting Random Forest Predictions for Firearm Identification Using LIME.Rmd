...
if(!file.exists("../data/hamby224_lime.rds")) {
  ...
  hamby224_all_results <- map(.x = nbins, 
  ...
  # Save the lime and explain results objects
...
if(!file.exists("../data/hamby224_test_explain.rds")) {
  ...
  hamby224_test_explain <- hamby224_test %>%
    ...
    full_join(hamby224_explain_results, by = "case") %>%
  ...
  # mutate(feature_bin = mapply(bin_labeller, feature = feature, 
